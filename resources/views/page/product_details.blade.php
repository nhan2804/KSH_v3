...
<div class="container">
	<div class="product-details-header">
        <b>
            ...
            <a href="{{URL::to('product/danh-muc/')}}">Error</a>
            <i class="fas fa-angle-double-right"></i>
        ...
        <div class="product-details-body">
            <div class="row">
                ...
                <div class="col-sm-5 d-product-body-details">
                    ...
                    <div class="d-product-details-item"><b>Kích thước: </br></b>{{$pro->size_pro}} </div>
                    <div class="d-product-details-item"><b>Giá bán lẻ: </br></b> {{number_format($pro->price)}}vnđ </div>
