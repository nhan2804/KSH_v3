...
<div class="main container">
	<div class="row">
		<div class="col-lg-3">
			...
			<h3 class="product__heading--cate mobile-product__heading--cate">
				Danh mục sản phẩm 
				<i class="fas fa-chevron-down product-down-icon "></i>
			</h3>
			<ul class="product__list--cate mobile-product__list--cate">
				<li class="mobile-product__item--cate product__item--cate"><a class="mobile-product__link--cate product__link--cate" href="#">All</a></li>
				@foreach($cate as $k=>$v)
				<li class="mobile-product__item--cate product__item--cate"><a class="mobile-product__link--cate product__link--cate" href="#">{{$v->name_cate}}</a></li>
				@endforeach
			</ul>
		...
		<div class="col-lg-9">
			<h3 class="product-title--mobile">SẢN PHẨM</h3>
			<div class="row">
				@foreach($products as $k=>$v)
				<div class="col-lg-6 col-md-6 col-sm-12 col-12 mb-4">
					<div class="wrap__product">
						<a href="{{ URL::to('product/'.$v->slug_pro) }}"><img class="img-fluid" style="width: 100%" src="{{asset($v->url_img)}}" alt=""></a>
